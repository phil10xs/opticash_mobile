...
class InputValidator {
    ...
    return (fieldValue) {
      ...
      if (Validator.isPassword(
        ...
        isNumberPresent: (present) {
          if (!present) mainError = onNumberNotPresent?.call();
        },
        isCapitalLetterPresent: (present) {
          if (!present) mainError = onCapitalLetterNotPresent?.call();
        },
  ...
  static FormFieldValidator<String> maxValue(
      {required double maxValue, String? message}) {
    return (fieldValue) {
      if (fieldValue?.trim().isEmpty ?? true) {
  ...
  static FormFieldValidator<String> minValue(
      {required double minValue, String? message}) {
    return (fieldValue) {
      if (fieldValue?.trim().isEmpty ?? true) {
